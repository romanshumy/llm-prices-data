...
**34 providers** (OpenAI, Anthropic, Google, Mistral, xAI, DeepSeek,
...
*Last sync: 2026-09-16. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (16600 dated points; see caveats) |
