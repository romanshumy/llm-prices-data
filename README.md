...
*Last sync: 2026-07-07. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (1782 dated points; see caveats) |
