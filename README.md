...
Machine-readable LLM API pricing for **219 current models** across
**36 providers** (OpenAI, Anthropic, Google, Mistral, xAI, DeepSeek,
...
*Last sync: 2026-09-25. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (18994 dated points; see caveats) |
