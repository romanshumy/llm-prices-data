...
Machine-readable LLM API pricing for **209 current models** across
**33 providers** (OpenAI, Anthropic, Google, Mistral, xAI, DeepSeek,
...
*Last sync: 2026-09-12. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (15560 dated points; see caveats) |
