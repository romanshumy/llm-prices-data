...
*Last sync: 2026-09-17. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (16861 dated points; see caveats) |
