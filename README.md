...
Machine-readable LLM API pricing for **166 current models** across
**25 providers** (OpenAI, Anthropic, Google, Mistral, xAI, DeepSeek,
...
*Last sync: 2026-07-09. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (2122 dated points; see caveats) |
