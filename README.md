...
*Last sync: 2026-08-19. This repo is updated automatically after each refresh cycle.*
...
| [`price-history.json`](price-history.json) / [`price-history.csv`](price-history.csv) | Per-model price timeline (9803 dated points; see caveats) |
